      ...
      <div class="lote-card-body">
        ...
        <div class="lote-card-footer">
          ...
          <div style="display:flex;gap:.4rem">
            ...
            <button class="btn-danger btn-sm" onclick="Pages.eliminarLote(${l.id})"><i class="fa-solid fa-trash"></i></button>
        ...
        <form onsubmit="Pages.procesarSolicitud(event,${id},'aprobar')">
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="solCuotasApro" min="1" max="25" value="${s.numero_cuotas_solicitadas}" required oninput="Pages.calcCuotaApro(${s.lote_valor})" readonly/>
            </div>
            <div class="form-group">
